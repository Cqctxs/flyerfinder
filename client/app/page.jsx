  ...
  return (
    <>
      ...
      <div className="w-full h-screen flex flex-col">
        <Image src="/images/farm.jpg" alt="Cover Image" fill={true} className="absolute top-0 left-0 w-full h-full bg-cover" />
        <div className="flex flex-col flex-grow relative items-center justify-center">
          <div className="font-advercase text-9xl p-10 bg-black/20 backdrop-blur-lg rounded-3xl text-white -translate-y-32">
            Flyer Finder
